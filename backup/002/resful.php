...
class DatabaseAccessObject {
    ...
    public function query($table){
        $this->last_sql = "SELECT * FROM {$table}";
        try {
...
$gieidb = new DatabaseAccessObject('localhost','root','','travelmoney');
// $myquery = $gieidb->query('token');
// $array = ['token'=>'0527705', 'id'=>'1'];
// $myquery = $gieidb->insert('token', $array);
 $myquery = $gieidb->execute('SELECT * FROM token Where id=?',[1]);
// echo $gieidb->diu;
 print_r($myquery);